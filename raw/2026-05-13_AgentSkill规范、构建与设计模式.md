...
本文深入解析了AI Agent生态中Skill的规范格式、构建方法与设计模式。文章指出Skill并非简单的提示词，而是围绕任务、工具和流程的结构化行为设计，作为可复用的增强包为Agent注入领域知识。其核心规范基于SKILL.md文件，该文件由YAML元数据和Markdown指令组成。
...
| --- | --- | --- | --- | --- |
| ![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1znWED6TPkEO3AYapQNsHcnXwPMQVtNvh6sbjOw2k7yV5icywKNicLB5rWdyeVA0PBlfGAoCiazXEGHwul54wTicBpSriaEUUz90VOI/640?wx_fmt=png&from=appmsg) | ![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1zynSPMsvBBewCjKj9tkU8v31KQ5NAsf0vHQtEgeSPlqZsnvZQdYknunyichm0Ou1JOv5RyIGA1SZ8txfm1dfQr23Ddwc6LyRu8/640?wx_fmt=png&from=appmsg) | ![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1wY22pGjkwsicq9JY5uoSvVicxlOiaCHKvJeBz7OIia1hoPxdnM3D9guFSFiaAmT2pVZkhfAAia5a6NgZbhq65GzKSdxISrUwFAGeIe8/640?wx_fmt=png&from=appmsg) | ![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1ws0AGRmI0t3IE2sUVsGaApYzkYttgLBrVxLibuLIiayzbiaakhQyH9vEoCn2IfQRgLhAIzUAXScQTMT7ic3XXGnSJKrHxWauPDk2A/640?wx_fmt=png&from=appmsg)  ![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1wXaSvOoaiajnMdKK85jcnS5ibjhjZGPmGicmvIUHpbrc9F96MpICxHXeT33pXD7BhmGOwgTUEjb4Dn9lVr3RuDmbjqniaSLUSKrqY/640?wx_fmt=png&from=appmsg) | ![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1ySSv898jOtVJRbVSzULyIVGl5tvY1paSMEls7eFKtq3RJJW70gd2FJkBKdV78UhCHbTDgy0ycJ9DZHKTWHhNJDYrRNDdQzu6E/640?wx_fmt=png&from=appmsg)  ![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1wne0ZlyicBJnaALIaIpjvhc0eo2wgoxcgW2aHxsOiaf938C1Dia0aCeS8ia0VhricNsnSUK3ws0RFiayUqZm5K7kXriagxs0HLrFK3uA/640?wx_fmt=png&from=appmsg) |
...
```apache
python -m scripts.run_loop \  --eval-set evals/trigger_eval.json \  --skill-path path/to/code-review \  --model claude-sonnet-4-20250514 \\
  --verbose
```
