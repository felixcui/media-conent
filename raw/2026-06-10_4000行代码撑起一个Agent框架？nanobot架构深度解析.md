...
**来源**: https://mp.weixin.qq.com/s/6m2ezyi119r8NLMBjsARDQ
...
System prompt 里明确告诉 LLM：需要用某个 skill 时，用 read\_file 读取它的 SKILL.md。
...
当 unconsolidated\_messages >= 100 时，异步触发记忆整合：
...
MCP 工具对 LLM 完全透明，和内置工具无区别，只是名字带 mcp\_{server}\_ 前缀做命名空间隔离。
