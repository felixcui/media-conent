...
**来源**: https://mp.weixin.qq.com/s/0DGAr-N-rrYJrzxc2yiGEw
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr69qPxmX4HiacJjXibBpJgsiaUTVd1eA6lA8GIB56Qjswtg4oplickN0JzHsdFxLU5FGp4rIcYKEyibGA8nhIneI1pxkW5rw217NuPs/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr7HG86VSSO6oAY4rtje7WpN4S2fdon2C88Yic7JI0iagJic5K6ArXv8tacLyWERiaxQDoT5wEFtM1EEiajia2icBXCsj2ibh4BicsHPWu5U/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr7ic22KfTtVIaXw6Iaj1seH8v3XRcjEwl69LLXicqag7sHibEvaZSubUPHRfBUps62GnA6fxlNTgHOB42CcKhtmjDDTlibS3NtpjZo/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr6Gqdyl1zpGZVwNIic3QAU3icxKH5o0Sic9LcKEL0FMXwXLlUib0ibKvVdjxPbgOEebxc84SiaDjnhwbBDzDiapny4qOO3upsd83WNLWM/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr64HTjXiafia2YFbxqgK8qIVIibKu5SVTg2dk9lP2r31XVz7aiak09gPibDvgsy4KuKF9PyXWVMR2V2k6B4DkYsohuZ55top3icJvgys/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr4H5VLc2KIusuia3jvn6p55PIAJ9mx5BCTianWbPKKdzDwEuLBqL4ic5wuHSYhvG4dzB5icMZvKibvVKW8Q7tXXS5zIbNJaMEhuITl0/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr5qOyicUlxiaod3DBA2SzmHicdLSMD8Zc8VXnLH8WPVMvbjFR5oJHpyfqFHLGYeIiaPkRSOvzsQrnvDIiaoFZOD4zCJE8nZetP6rsD8/640?wx_fmt=png&from=appmsg)

这三种拓扑不是互斥的框架选型，而是可以拼装、嵌套的积木。真实的生产系统里，常常是主管模式套着几个菱形，菱形里又是流水线。

## 07

Anthropic 官方的五种工作流模式
...
![](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr500nuIkI4lFU3NiaOu4KjAmicrUr3BhtG4410G36dqNy8oicn2mJURvPPQ1BBia6ItllMnjXs3txicAazmo69iavRtClhDkaEG3tnd4/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr5O99Adj1oVzuqiaatBibC1fia3CWibGTbY1zQRZuBJZI8NP1uXqrhG1BrLUXERkzFY1RE2545KUWAyUXYicw15kk3OXJVUrvcocbYc/640?wx_fmt=png&from=appmsg)

Graph 的解法是把"做判断"和"做验证"拆成两个独立节点。出结论的是一个智能体，专门挑错的是另一个，叫 **Verifier（验证器）** 。它的职责不是再写一份答案，而是 *专门试图推翻前一个结论，扛得住才放行，扛不住就打回重来。* 关键在于它要用一双全新的、干净的眼睛，只看最终结果，不看是怎么憋出来的。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr4Fg53icWC7UBtDTzvlPrKOia4f7OdKnDHUyl7PgK7egNibvfx2CSiaooC6JS12vNGrlmB2r0y1WibmWsLiccr5Jgk17LRKtX7iajsQrA/640?wx_fmt=png&from=appmsg)

检查的力度要看事情轻重，这就需要一个 **Router（路由）** ，像医院的分诊台，按重要程度把任务导向不同的检查路径。普通观点快速核对，重要数据和安全结论则要多角度交叉审。常见的验证有三种打法。

![](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr5gksjy4yp2NjngIH4WZA0wSbiaVTmickCswTBVvLg0icUJzoJdsKU7LQeRAqBaod6ichAVshdLDtVIEFMsLK3UVDiaJbaRfrO5rODU/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr7hqdQqHFGTjH88aH7Xer3ePTN4HHiaKX26gmWoZTf08jwDXTyNbtZialn6ibpdSy6Gme4e0YeYqpop604BW6icI8xCCGbP4Vrxm7Y/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr7JpibzLovrBJib4jvX6wIbiabyJ0JlRib3m8xU7ibpH6YQDz7FZXCtHQkhJhzUBcR71n0LoXVZSlIpR9abunGBTSVcamRa4HpG95zE/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr4ULFpKP0t3Q5hxESZvoy9O4BhTArjib0a1YrfzeeDUesSbPBicd8meBeXEdt0H1vny8yA4jqJSywcQEu59IJCbx38XMQcg0OgHw/640?wx_fmt=png&from=appmsg)

这组数字说明了一个残酷的权衡， *多智能体确实更强，但它是靠烧更多 token 换来的。* 所以它只值得用在那些价值足够高、足以覆盖成本的任务上。Anthropic 给出了三个明确该用多智能体的场景，也是判断该不该上图的三把尺子。

![](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr6ATq28yw41mIiaatZQDsowp1jqdADvkWg1TqyaUIhNKKDHAOsmfJ6jLdJVW7sPgShA1jdGWgVybMVHQkseEDialDD8s9rLKd3no/640?wx_fmt=png&from=appmsg)

反过来，如果任务就一个目标、一个领域、一个明确的停止条件，那清晰的单个 Loop 就是最优解。比如让智能体每天检查一次仓库 CI、失败就总结日志发你，这是完美的循环，硬拆成十个智能体只会徒增延迟、成本和调试难度。判断只需先过一道最简单的坎。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr4IOIf3lnevGibm0nlqrbg7bibA8Qu4CadThPzXWVTSicfJcjaS9UETF7TsLLZlG0ILib2IFKzhdoldm43ovU06ia9HDm6libKCMIyLo/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr6iboLSGPkgKWr3UhJbQP9bfc0DZzMlTniamCJSkSqdtibNib1Zzv4e7yr1QDibF4gBkbEojLclMESyBicKNw2bUnrXEuC0WAYTVtpEQ/640?wx_fmt=png&from=appmsg)
...
更妙的是一个叫 **待写入（pending writes）** 的设计，当同一个超级步里有个节点失败了，其他已经成功的节点的输出会被留存下来，恢复时不用重跑那些成功的节点。这些工程细节，才是让智能体从"能演示"变成"能上生产"的关键。说几个真实案例。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr6qRIpEQlJ6icv0n2Rcl2gCd4wk2ibUcc12rtUgookvDLBWs6BiaHdvq8ZVwuh2LILHGTZB8ib3DEo7QM3ibOg6le4h1jdCbn0JUGLs/640?wx_fmt=png&from=appmsg)

Graph 的巧妙，是 *把"稳"和"活"拆到两层去解决，而不是二选一。* 让边和整体结构固定下来，所以可治理、可审计、每次分类走同一条路，让节点内部保留自主，所以够灵活、能应对具体问题。这正好呼应了 Anthropic 那个官方定义，工作流是"通过预定义代码路径编排的系统"，智能体是"由 LLM 动态决定自己流程的系统"，而 Graph 恰恰是两者的融合，用预定义的边框住动态的节点。
...
你对本文内容有哪些看法？同意、反对、困惑的地方是？欢迎留言，我们将邀请作者针对性回复你的评论，欢迎评论留言补充。我们将选取1则优质的评论，送出腾讯云定制文件袋套装1个（见下图）。8月11日中午12点开奖。
