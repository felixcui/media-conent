...
**来源**: https://mp.weixin.qq.com/s/lO2WKHD-L0dTfHhXV-Um6Q

---

## 摘要

针对支付宝商家中心PC端测试链路长、自动化维护成本高及线上风险大的挑战，本文介绍了PagePilot这一PC端AI测试Skill的设计与实战。团队转变思路，从编写测试代码转为沉淀组件化知识库，结合AI Agent、浏览器自动化与DB验证实现端到端测试。因现有平台方案存在账号受限和流程控制粒度不足等痛点，团队最终选择自建Skill，打造稳定、通用、轻量的全链路自动化验收方案。
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/j7RlD5l5q1xicuTvib2gtGLPfevibUr2KV4zRjbMPIa2rgmsT6efvt2JfSsbXYa2dLRjzoQJKjNQoaygdaZicDkAmc5DBwf03bSwEcGFOsmxC2w/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1yotRYfswP1SZiaUhSZiaLwxgnLTia735kfKLniaVnRNlicNwJr2aicqibNs6hS7ticAmqtuLfzdYiaWyLJwI2uFl8dmnlwVm1iaTFHRoEFQ/640?wx_fmt=png&from=appmsg)
...
| 验证手段单一 | 无法获取接口响应和 trace\_id，无法从 URL 提取业务单号串联 DB 验证，页面验证仍依赖人工 |
...
| 页面崩溃表单丢失 | CDP session 崩溃，已填表单全部丢失 | window.\_\_formState 表单快照 + 崩溃后重登恢复，上传放最后最小化崩溃暴露面 |
...
![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1xVX63llWwkeFJ06T2rK2jHPq24u4EmUpHoibxSMovU7gcMqRXxkhfYIv5csxbyng5lDKiaqtx2RUJnyWqF3WZ6uHbdKTx51ngrs/640?wx_fmt=png&from=appmsg)
...
- 入口 URL：从哪里开始
- DB ARN：验证需要查哪张表
- 期望断言：如 biz\_status = BLOCK\_WAIT
- 钉钉群号：结果通知发到哪里
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1wvbcpZt6EXfwOKMNm89E9m1RghqibuXg31icAicDPs2Im50iaSYQxsrV8mqiaLcxpb97TurAibDmQ27micAIqaM5hBRLqDxHHoDFr6fE/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1wx4g9wbgVHXKeocHV8KyIkogoVo7Vh6d4VdmQqJpia5vbYNytt8Z9Qialweg4JSNFoQ1Qlwq7e7Ny4rib1icLfteib4fwRoJtubHqo/640?wx_fmt=png&from=appmsg)

原先人工：一条 Case 手动操作约 30分钟（含等页面渲染、填表、上传、截图），7 条需要半天-1天

Skill 自动执行：7 条 Case 在 30 分钟内全部跑完，提交+撤销 DB 双验证全过，自动截图 + 自动归档语雀 + 自动发钉钉通知。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1ytRR6VvxEYxuhmJM1mxB0ib6OCooclUdrwBg6QxcTtbBXbPvjzlZZ4y0H9C3Ba0yW8uvKHME8Y9rNgibsGCwh4Ticoica4FKTmEhc/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1ybicAdlfx54qUPK1jayPkPdHB98A2lEiaJvbNpXhl4X6Pu2TkT1U5UEGicfsnBNibzEhl0KN62q8xcaprjg44FDUqv79Vy0q6hwm4/640?wx_fmt=png&from=appmsg)

② 执行case

![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1zIiaE9Hg2zAyLnGhfQaEPGPFtgFVCKwiaHaakvGWwuian7MjRIsgWibBplzJ8brHcM0IuYvibKjKxericlI3Tfsb8Cq7oojJZlyrfHo/640?wx_fmt=png&from=appmsg)
