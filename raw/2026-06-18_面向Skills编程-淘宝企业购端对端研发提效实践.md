...
**来源**: https://mp.weixin.qq.com/s/8wJhwC4YuaOX-8GXMaFU5g

---

## 摘要

1, the user wants a summary of the provided article, with strict constraints:
1.  Direct output of the summary.
2.  Under 200 characters (Chinese).
...
![](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp2NTQyuDvia8qXDes4I4rf08nYD1wvDl1EibdHR4KO9f3EmxiaMOVJRKP8sp4ZlyiaAJ9uI0G8bVSO4BnqY0l232jyomeI2KP44Xiac/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp1A70wmmuvNibTXPZ25hgBUKUNvgZOF6ws1RPlD2ibiavk6DH9FUIWYzsDWv7KWxmgADWmKgLJrFc4AT36ex2xWXZcSjqqut4QGno/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp1xK1ib8NC6RnjH6ZiazlQp8Ux7RMib2U3LUS84n2b9o60tNxoVGF8dbibBg5YtjyE3VqCicCWGovlweicTBpP7Uks30GHICl9xSknsc/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp1mNIAvic96UbRia131sicqD9fSQAJJuq2ibOpWyOIZUl1hL29gaicGcOmUHUT3ffgqL5jQsV3gicNIILKfpyjRNm12waIGo5nEnLyVw/640?wx_fmt=png&from=appmsg)

## 落地路径：四步构建你的Skill体系

不论你在什么业务域，都可以按以下四步构建自己的Skill体系：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp0sZyJvdckahFQvqtzB7lUAZXrGrMYjT5jhGb9iaaROg7SWM3fbic3A6qMwX89eCYC7licWjWbHIY5jZAgqVPQ2tUQ07Ey0dCfIDQ/640?wx_fmt=png&from=appmsg) ![](https://mmbiz.qpic.cn/mmbiz_png/33P2FdAnjuicZrWZ3a7SNVtibcNht0QoXTXKZWKec4l37w6NC4la1sV53zcZqqMO9wnqskOicSVEFvXiboFHlhWDbg/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp0mdDumC209vbvaPGkaK9r8mUTnFgm8wvxSN1WSThBrvMLRfg7EDHudqtdKMTwzbzMNS5S55ichGWFNBkCRWutpmgI9rDPZmPuk/640?wx_fmt=png&from=appmsg)

对接工作涉及三大业务域——商品（商品信息同步、类目映射）、交易（订单创建、物流同步、逆向）、结算（对账、结算单、发票管理）。由于每个客户的接口规范各不相同，适配代码几乎无法跨项目复用，每次对接都需要从文档评估到代码开发全流程重新执行。

主要工作构成：

![](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp0N41oa5hKUicbHaSodBmwkvjkdnRRxOJWboXKqIKGcPfkeZxDb4poF0hczQHtpG7MSz0vnsz3l2FiaZO5xuQyXIQtHicJb9X1Mqg/640?wx_fmt=png&from=appmsg)

▐核心痛点

这一业务模式具有四大典型特征：对外对接高频、需求碎片化、技术方案重复度高、交付周期敏感。在传统研发模式下，面临以下瓶颈：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp2GPxiaHICsPXojLxptIMndnqcvtbBQXiakiavUqedLr4O09EcBXJlPMJhM0VM7uPWIUxf90RoDvXejRClPsyZndEEr9gKL1DqgBE/640?wx_fmt=png&from=appmsg)

核心问题：当前以人工为中心、AI辅助的研发模式无法满足业务"快交付、低成本、高灵活"的诉求。

## ▐ 成果速览经过近半年的系统性探索与实践（2025.8 - 2026.2），团队在研发范式、研发效率、技术沉淀三个维度取得了阶段性成果：研发范式升级从"依赖个人经验的对话式编程"迈向"基于Skills的工程化AI协作"，实现端对端编程实践探索，以人为主导，逐步转向人通过Skills传递经验给AI，指挥AI编程。研发效率提升

商品域端到端交付周期从23.5人日缩短至8人日，整体提效65%，代码一次生成成功率达到90%。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vv
640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp336OLs2FoJB4V6LKG0cNpsRNZufqicRMOG6ttezlJpbAYqtnH0sggHS8CxxrBEUpQXxQJ3jXpSWbrlZk8fic6kqribHIzia0FXGkY/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp0ZG2iciazXM5hXUT01T8ia1C158cROCQHibWvrNGwfo7rLhz3WwicSJrbbkxC3Hxa6n6yUgVSKWtriaU10icF9FCdmCfvUHWicMCxpUUk/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp2FcSFOS2sKO9POhrQAPusSWhMNtNVY8psfkte1tib4MplLkCzRY6u7JRUxXC8BibSRRjsj2qQH74l7l00X4U4ZmFN12FYq2VI5g/640?wx_fmt=png&from=appmsg) ![](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp2y7zTHLAV7onf3iclRsDMKxSPR5JeSvKGNA22k8hjYD4I2ZCfmvBQd4U78zKQqU3M4NnFaHExBKCib8qZpQblTU5ku9mFeob3fY/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp2XST4HOgB8PV340v06hdpcXicyvHMkVbB7oPnZicPa1lnjstx5NUxbxHbomBet5dt4Gk5cKbnXhV4r8FfGa48lGgYClVOJFWFOs/640?wx_fmt=png&from=appmsg)

问题闭环：同类问题跨项目、跨模型反复出现（如XX系统修了SPU/SKU混淆，换B系统又犯），通过ADJUSTMENT\_PLAN机制（发现→定位Skill→补约束→验证→交叉验证）将11类高频问题全部沉淀为Skill约束，不再复现。
...
- AI用 `ItemClient` 而不是 `ItemClientWrapper` （后者封装了ID映射和参数校验），运行时报空指针
- 生成顺序不对：先生成SPI实现类，此时请求/响应基类还不存在，编译报错

解决方案：

- 工程初始化Skill前置：将项目骨架搭建（占位符替换、AKSK生成、Maven编译验证）拆为独立的 `ego-project-initialization` Skill，确保代码生成在一个可编译的工程上进行
- 代码模板驱动生成：将 `ItemClientWrapper` 使用方式、工具类API、注解规范、Request/Response/Converter/SPI四类代码模板注入Skill的 `references/code-templates/` ，AI按模板填充而非凭空编写
...
![](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp1Wuh2WfV0iaicLRKMfIqJdouXY5olb2thKOz8ZtgqYUFjlUwdHF1OyFxSWibPBA7hbxkt9M2ZicrU6zDRD236zlP3B0Jic34EfbjAI/640?wx_fmt=png&from=appmsg)

## 质量控制

通过「事前约束→运行时约束→事后审查→人工卡点」四层防线，贯穿评估→方案→代码全链路：

![](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp34e4uuDWLvicicmvOVjLFr4UicSMeOe3EpLpFhgdl08BNVkR0NfUV3zYEAs85DzmhrEMH7ZOjNd0eiaUgZh2dyq3j3VGKL1pUBwGQ/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp1vthaL69Z07fE5cnOibgvPfeHH7sxh5ecl3PfylIuriaqokDAvCicHtXMr3IicPkAMd3SpRqQic7XVkW1VTvcPImdzpT4xP3ibpLdtM/640?wx_fmt=png&from=appmsg)
...
构建了CLI工具 `kn-fetcher` ，支持知识的拉取、搜索和批量分发：
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp2YdngTDA5MZnhP8bIaV2h6rha193L7fa3w5kEQ4eOMleyMV95BPJXf6kTFBiajPXhsev0K3JNDUaYibM6Ng8HVQkZPQCnscol0k/640?wx_fmt=png&from=appmsg)
