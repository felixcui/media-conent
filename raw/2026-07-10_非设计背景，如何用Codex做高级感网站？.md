# 非设计背景，如何用Codex做高级感网站？

**来源**: https://waytoagi.feishu.cn/wiki/Dn3VwfswWiBKpjka3HAcKbyCnNd

---

## 摘要

非设计背景者使用Codex构建高级感网站时，切忌直接让其写代码，核心经验是“先做设计说明，再做页面”。应先要求Codex生成一份DESIGN.md，将抽象的“感觉”拆解为页面表达、受众、颜色字体、排版及需规避的“AI味”等具体规则。此外，避免让AI盲目猜测，需借助现成的风格参考网站直接获取设计语言，或使用工具提取真实网页的设计规则作为参考，待确认设计说明后再进行代码实现，从而摆脱模板感，打造出有质。

---

## 正文

> 🔗 原文链接： [https://x.com/Jackywxsz/status/2072...](https://x.com/Jackywxsz/status/2072614425660731498)

![](https://feishu.cn/file/Y0hkbcfAIo5n5uxPABdc4AKGnCb)
...
> 这份 DESIGN.md 要用普通人能看懂的话写，不要堆专业术语。 
...
![](https://feishu.cn/file/PIZmb8tO8oh0jyxcSiNcjzd4nxV)
...
![](https://feishu.cn/file/Q7mJb1S6bowMe2xsxWvcPaKEn8f)
...
![](https://feishu.cn/file/YuMyb8mDBoBxfVxWfDHcB6CunHe)
...
![](https://feishu.cn/file/I2hYb6BBAod0zuxgsescDzSyntc)

- Page Flows：[https://pageflows.com/](https://pageflows.com/)

![](https://feishu.cn/file/LE6QbvBNKoFGwGxut5kcRJQ2n8c)
...
> 3. 不要复制参考网站的 logo、文案和图片 

> 4. 桌面端和移动端都要适配 

> 5. 完成后启动本地服务，并在浏览器里打开检查
...
![](https://feishu.cn/file/O3TMbFmkvodG7Xx4aotcFKVTnIb)
...
| 你要做什么 | 用哪个 skill |
|-|-|
| 普通网页想去 AI 味 | `design-taste-frontend` |
| 有参考图，想做成网页 | `image-to-code` |
| 没参考图，想先出网页效果图 | `imagegen-frontend-web` |
| 做手机 App 页面 | `imagegen-frontend-mobile` |
| 做品牌视觉板 | `brandkit` |
| 改造已有项目 | `redesign-existing-projects` |
| 做极简风格 | `minimalist-ui` |
| 做更强视觉和动效 | `gpt-taste` 或 `high-end-visual-design` |
...
> 请使用 taste-skill 的思路来做这个页面。 

> 如果已有参考图，按 image-to-code 的流程：先分析图片，再提取 DESIGN.md，再实现。 

> 如果没有参考图，先用 imagegen-frontend-web 的思路生成网页意向图，再提取 DESIGN.md。 

> 实现时用 design-taste-frontend 的标准，避免常见 AI 味。
...
> 请对照 DESIGN.md 和当前页面截图，列出 5 个最明显的问题。 
...
> 1. H1 改得更像个人站，不要像产品官网 

> 2. 首屏右侧图片替换成更有个人内容感的视觉 
...
![](https://feishu.cn/file/ND3QbQGhMoStWfxRxrrcCib1nAd)
...
> 替换后调整尺寸、裁切和留白，保证和 DESIGN.md 一致。
...
![](https://feishu.cn/file/Heu9bP5kAoZPLBxJYB6cW1bwnah)

![](https://feishu.cn/file/GkSJb9OHxo2H7Mxoxh3ceqvWnmb)
...
> 我已经在 Cowart 里整理了参考图、当前页面截图和要替换的素材。 
...
> 我想用 Codex 做一个有高级感的个人站。 

> 这不是一个随便生成的模板页。 

> 我希望它能表达我是谁、我做什么内容、我想给别人留下什么印象。 
...
> 第二步：写完 DESIGN.md 后先停，等我确认。 

> 第三步：我确认后，再按 DESIGN.md 实现页面。 

> 第四步：完成后启动本地服务，在浏览器里打开页面，对照 DESIGN.md 截图检查。 

> 如果页面不满意，不要重写整个项目，先指出问题，再逐项修改。 

> 注意： 参考网站只用来借鉴风格。 

> 不要复制它的 logo、品牌文案、图片素材和完整页面。
...
![](https://feishu.cn/file/T6lKbYWCro8iswx8md5cuVk0nZb)