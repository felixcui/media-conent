...
**来源**: https://mp.weixin.qq.com/s/9ikvuGaAJSPyGYidbAdC7g
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/j7RlD5l5q1zdv6B1oaR6SZUicWTZ6OPhYTlLdqaLMmJdicCuNhA3B8icico44XnkiasarpNBazNNFOCaKy64a855Ljl7TOOmn6QfUvzhWpuQfByc/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1yWTZxfQKAb8FOXrTukLZxaRnb3nPMJicUFMFGPxywolW7iaS6fLWQfAc1A35jAceAJdkLPtehVkHYlm9UMFEqaKibOiaXEPxwfVtQ/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1yFHjOyhI4a5icXUZYNOKQicibBibabiaU4BTaAA4iaicMOEJXDz1xDIicokS2YTtE8uTXXe4HXON9RUMLDQ7aSe0kAC9efciaBdlibpH7Ck/640?wx_fmt=png&from=appmsg)

二、AI工程范式演进

要理解Harness的位置，得先看清楚我们这几年是怎么一步步走过来的。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1wBtKHoibMm2AIFvW7OJ7qP9lSc81VvRL6xwLgLDyDdpiaj2L56bKribuAicpHWRqoMrNXLPMx7jhib4G5q5icWggXvfbTa2jdib4TmEw/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1xv9vgrS8fic1lppra1dZ2ian9GndVNLr9WlKFkpQFgpV724pBVuB56r90ib7mVOD6nmIqC5w3GmbcwXTrTmgL0qibg1UnOb9sEDGA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1yEEjib9hVdNibx2fvRWSRciaVwsI02xhEjDY0aM9h0tsNe1xdia8COu4du5s2hH7YsU2IdzxDNVCeee52HcnVBt4TaH6suBCYtzUk/640?wx_fmt=png&from=appmsg)
...
<table><tbody><tr><td><p>具体问题</p></td><td><p>根因类别</p></td><td><p>对应支柱</p></td><td><p>Harness层</p><p>级</p></td><td><p>支柱定义</p></td></tr><tr><td><p>Agent 越界发挥，本该写需求文档的去画架构图了；表命名不规范、PK 不唯一、分区格式漂移</p></td><td><p>角色和能力边界不清、约束体系不够强</p></td><td><p>Identity</p></td><td><p>身份层</p></td><td><p>定义"谁有什么能力、什么绝对不能做，什么可以做，如何做"，负责明确角色定义与约束体系</p></td></tr><tr><td><p>简单需求也要走完全链路，用户等不了就不用了</p></td><td><p>流程缺乏弹性和效率</p></td><td><p>Orchestration</p></td><td rowspan="4"><p>执行层</p></td><td><p>定义"按什么顺序执行"，负责流程编排和智能调度</p></td></tr><tr><td><p>上一个需求的字段名串到这个需求里来了</p></td><td><p>上下文污染和信息管理失控</p></td><td><p>Context</p></td><td><p>定义"什么信息在 Agent 间流动"，负责上下文工程</p></td></tr><tr><td><p>Agent 觉得"这次很简单"就跳过了检查，结果翻车</p></td><td><p>缺乏强制性质量验证</p></td><td><p>Gate</p></td><td><p>定义"做得好不好"，负责门禁检查与质量评估</p></td></tr><tr><td><p>流程中断或子任务失败后导致从头开始，之前 30 分钟的工作全废了</p></td><td><p>没有中间状态、无法支持断点恢复和分级故障恢复</p></td><td><p>Recovery</p></td><td><p>定义"当前在哪、下次从哪继续、出错怎么恢复"，负责状态存储和管理、保障故障容错和韧性</p></td></tr><tr><td><p>同一个坑反复踩，上周犯的错这周又犯了</p></td><td><p>错误没有工程化为经验</p></td><td><p>Evolution</p></td><td><p>进化层</p></td><td><p>定义"错误怎么变成经验"，负责学习和进化</p></td></tr></tbody></table>
...
![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1z10ucULPTo5koMVoKACycstbOddSYqgZuddpEGE7MWwNtY7z0OcOO2rrQavm56L62ibl21PlFrUicCmPmDYnFsbBBCdkyH8nY24/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1ysVpZED4JsQ0mZfJKSZvWOQjAE9dnnKuO6Ify1kNADwbBKIicsCPA13G2KfnZ5chBJAAJGGNja5YVUiaPW4A8icC60ICQwicdXr8Y/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1wjib7wic52usdm145BrKwCkSyhI44cDQyAN8q0InIHXJiaIbKPZ8A2ddbWGdEHKSWEmreYGpCYiaRsR1ElrqzjMMJUTHwrB6pqxJo/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1xVyU1lv4qU4RicwFJTXYjiaY4Qq1LHDjBHLiaibjlsl00Aiae145I9R7tc052cVcoU8VqeMo4NGy80DDibu4Iq1ATLiajddsuVKHeQWE/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1zcD50dmldOobwS1ttiaic9Ydf6yIrntsibxVFFdas7MVGgvuMHn2OOj1wU1GgujCemuicxxISxqQ67ia39IpECFa3c56lcGM53zSjc/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1zDz5pXpbE7A8kW9zDwE97qGdZ9SPtwlFplwjM0lGBl0k4e6b0dic0YYolp1SnGA7ib4ENlmibGicCmPDsR4pJ9nbJ4egRichwRvKfM/640?wx_fmt=png&from=appmsg)
