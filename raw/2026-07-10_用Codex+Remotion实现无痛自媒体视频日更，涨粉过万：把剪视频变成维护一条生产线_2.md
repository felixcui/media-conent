...
**来源**: https://waytoagi.feishu.cn/wiki/JCgmwD87piEa8BkAUcoco5PQnQe

---

## 摘要

本文介绍了一种利用Codex和Remotion实现自媒体视频无痛日更并快速涨粉的方法论。针对结构相似但内容多变的视频类型，作者提出将视频视为可维护的代码项目，取代传统重复的剪辑动作。在该模式中，人负责提供观点和判断，Codex作为开发智能体负责搭建生产线、拆解脚本为数据并维护项目规则，Remotion则通过React组件将模板和数据批量渲染成最终视频，从而实现高效、稳定的自动化视频生产。

---

## 正文

> 🔗 原文链接： [https://x.com/Zesee/status/20724170...](https://x.com/Zesee/status/2072417062165635433)

![这张图呈现了用Codex和Remotion实现自媒体视频生产的流程，清晰标注了从脚本选题、代码自动生成内容、自动渲染，到最终发布涨粉的完整环节，还明确显示达成了“10K+”的涨粉成果。它契合文档中提到的“把视频当成可维护代码项目”的核心思路，直观展示了这套工具组合替代重复低价值剪辑动作、助力创作者实现视频日更并快速涨粉的效果。](https://feishu.cn/file/IEvEbsh7bo41w8xoCYVc4Xy4nhh)
