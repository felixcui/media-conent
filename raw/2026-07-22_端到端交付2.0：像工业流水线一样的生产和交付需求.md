...
**来源**: https://mp.weixin.qq.com/s/xHLIFBbbxINRCRK20HgSeg
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/j7RlD5l5q1xAic6LwGicDFhtNYBnDuuOWjsAvz3YsKI9wHicXUhtsYf89LmNNGBxWTvjZKI96gMR6dHWsABoOw7ZFw4ibIvicooicGTnQS1KWnvhM/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1wSU4B3APS6DTbA3hujUTxVjGgZy72PjyNtfnmiaOErr3Tk2eiaZDDNgPnKkDrmJBAeiahjndmA5ictje5JOXog6pwwgqAJZIQPbYQ/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1wv4rYJUeQ8Xwz9Cf2TCuEuiaGkKXheicibFW2L7sM0eP0TRtVCfwtRDfyLTN2Ya1gTYmaViaKg4RRnBTtYmABAqGzzu8vfDUBIll4/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1yySX4zKiba0ZJ6N6vfAoZ8jjWPQUvadygEvjYBMzcickgia401nPEKdKiaoXhneyR4GrhBSW2QkN9Gib60Qs0HY6dgcp8VhbicQG5ps/640?wx_fmt=png&from=appmsg)
...
- 自检Agent：生成自检报告，输出check\_reports + ADR
- 测试Agent：生成测试用例并执行，输出用例与执行报告

反向链路是改进过程：阶段产出物检查 + Session log分析 → 发现问题 → 反哺物料优化和规则迭代。

![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1zk3HdAto0lB0Uvaq5icQUtUukRQkPjWPg8E4J6nAVOSBwCNxEAcDY5kAYGk0PbwnibHRTCI2SulMl4qa0yeO4ge23dLSjVUkZIU/640?wx_fmt=png&from=appmsg)

这个架构有三个核心特征，可以概括为"三可"：

可追溯：需求id贯穿全链路——从PRD到代码到测试，一个aone\_id串起所有产出物。Spec文档放在研发统一过程链里，任何时候都能回溯一个需求是怎么从一句话变成一段代码的。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1xc5l7bF0pZORRfJlhmickSqjfCicM1wOibDpEYAvknJWw2woU50yW8cw2XpJeibbXXkDetzVg41hDypO2oDGDBDtL52AhUF87a83A/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1yXOQgYWEOhgbzRu5sVDHsbqSOffs6kO4Ig5ENztibI0rQvOP8We2qca538UtQHujOpscXPEmQxPts4libqBcswSl2CAXrM0SXWE/640?wx_fmt=png&from=appmsg) ![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1yjR5HGgyIT7PVmgYCKDzRVW5jYgamSBjiaTEUsjXudNaFSgicyibTeVNbV4RZtaByOPF0m2VwJic928icjDNf0UB7vSnDAEjict1UcM/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1y9U9icCUBib0EpjxicaFia0PM9goM0VjyqPaMRa1veqreWCBJHP7JJ72U3fpa7ibeMuDCuwvdIA6DRAIXRWzJfhvt8awbBiafHoMuD0/640?wx_fmt=png&from=appmsg) ![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1wMM58Cc9v1aWzrmrrVtPYfrIiaJFKLsDMS1LZamdBI0dIxRSuygzzNVFONB4bswXiaSODPwrfqphChNRMbPab0jSMr3PACpIWs8/640?wx_fmt=png&from=appmsg) ![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1zlynWIaggT0eIbvGtPxkjicyicOwp8sKibsztVkok4y6OYujwbfdnD9ZQKxLe9GYNojJngib8MtR5nbl0kYzPyGkvMkxL3IibtfLlA/640?wx_fmt=png&from=appmsg) ![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1y1y0icjUbtbec4WQUf8qY0lXVyy4iam1E9biaWYa3Yygw8WkSLvNpU2tDOZVCakwJib6f9foPYJMuEAPakb7QolYl0icjEkYzbIxQg/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1zzhbYTuoQzwcFdqFtHu9A4QfKau5zeES7kBEnoqTicraOIrQupBUQBumiaJgeHtu5DTM60ZI8Tpjd5IOYkgXnvia3QzE0cFBR66U/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1zoeaJia2REhSLzBzka4mJ5DRiaWGG4YqbC3C2q8FIXAG846tTl65Kz0m0iahiaOucYgKCP2XIbysYPK9kglafYoUvdM24ee4U2tic4/640?wx_fmt=png&from=appmsg)
...
具体来说：云端Agent生成的spec文件夹结构和应用级完全一致（spec.md、plan.md、tasks.md、check\_reports/、session/），自检Agent独立执行检查，统计&Loop工程的扫描同样覆盖云端产出物。这样保证了无论需求是研发手动跑的还是分身自动跑的，产出物标准统一、可追溯、可验证。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1z4YiarYlbTCANQVV5icgkxUVv5DF8IkmicrUL5lbumgg6qWUaickvLmQib5sbNTH6Hsvt20zUGSZKiandCMjmoDal9I5ibAoIRzAQacs/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1y96licAxfo7oXjs7xpFI4r9dmWggf6z3mWMzaDic2XOOapPOv0iaCEfCD2ZS5GeOXUUrey14fjwAhwJdEhpiankuhWXMFficJojjib4/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1ylzc8uGCDAibnf2ItHSFR2oFGocxyhOcRBxwvcia9iamoDGoWS6wZWIQicdR6lZvM1TdYsic5U9tI9nA4IkGHW0tHNYnlLj6F3wy2Q/640?wx_fmt=png&from=appmsg)
...
- 阶段一：需求对齐——把模糊的需求转化为结构化的spec.md。spec.md里包含aone\_id元数据、功能规格（FR功能需求 / SC成功标准 / Given-When-Then场景描述）、用户故事。这个阶段的产出物spec.md就是后续所有工作的"合同"。
...
- 阶段五：检查——研发自检Agent生成check\_reports，多角度验证产出物质量，沉淀spec的ADR 内容到应用级。
![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1zZcmgRUb3xYqia5T2EpyrS9Z2CRHJC9g1YxYKGibC3tcEcWmjcoiaN1oxibzz6wnqXdnb9OQkUOClQT781JY5xGLQoARLVWHCEoWE/640?wx_fmt=png&from=appmsg)
...
- 结果产出物：spec.md、plan.md、tasks.md、代码文件、check\_reports/。这些是"交付件"，直接跟需求走。
...
| 维度 | 应用级（Solo模式） | 项目级（开团模式） |
| --- | --- | --- |
| 物料层级 | 应用级constitution + rules + skills | 项目级constitution-p（最高优先级）+ 应用级物料 |
| Spec文档 | 各应用独立spec | 项目级spec + 各应用独立spec |
| 接口契约 | 无（单应用内部自行处理） | contracts/api.md 定义跨应用RPC/MQ契约 |
| 准入机制 | 无 | Pre-check检查各应用物料就绪 |
| 指挥角色 | 应用负责人 | 架构师（技术对齐）+ PM（需求编排） |
| 任务拆分 | 单应用内分Phase | 按应用分Phase，各应用内再细分 |
| Git管理 | 应用分支 | 项目分支 + 各应用分支 |

案例：

![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1x2OYiaEjgF9NiaWLicUlcYUDTGRtJLcERYwiaOeAxKrU50AGKTl0zIibfJO6NX5Fiau5M32ewLRYTQBq3ourNb0OgtAxHrDKabWqlco/640?wx_fmt=png&from=appmsg) ![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1x8yicsjjJxgZxlDUoKEwy3PYlIOq4oLIyKjCtvpLYMFTtPbwQIq5nfb6PMdwyjLIAaD366jpc1l5jqAF0kocEzs3InVficmlt74/640?wx_fmt=png&from=appmsg) ![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1zTWGYmwHYyqHMsYVyQsCs0SOl5F8UibWugX96tiblYCGCfd6DGFQYLSLqYewtOx5ibIM6qQPNEicZIAEaFvyibDOicwbdQACXrA1vhA/640?wx_fmt=png&from=appmsg)
...
这里要先厘清一个架构关系：研发自检Agent遵循Spec规范，但它是一个独立的体系。 用Java的术语来说，Spec工程定义了一套SPI（Service Provider Interface）——spec文件夹结构、check\_reports/的格式规范、check\_summary.md的判定标准，这些都是"接口定义"。研发自检Agent是这个接口的一个"实现"，它按照Spec的标准产出检查报告，但它本身的运行逻辑、检查策略、执行环境完全独立于编码Agent。除此之外还可以有其他"实现"——比如平台扫描、自动化测试、SRE合规检查——它们都遵循同一套Spec接口标准，但各自独立运行。这种解耦带来的好处是：编码Agent不需要知道自检Agent怎么工作，自检Agent也不需要知道编码Agent当时怎么想的，双方只通过Spec标准"对话"。

![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1wAR24gWVtib9IVzUeiaPGr7Q9Ck4YhTlR1Mia4ozqL3uVuXl2kH1SJYM5KmqTtFvcR0LY6B52XpwU7uPfCuzGLNTZic04Ev3StsHw/640?wx_fmt=png&from=appmsg)
...
每个维度独立出一份报告，最终汇总成check\_summary.md，标注overall\_result：

PASS：全部通过，可以进入下一阶段

CONDITIONAL\_PASS：有非阻塞性问题，修复后可继续

FAIL：存在阻塞性问题，必须修复后重新自检

问题需要带上证据，所有报告写入check\_reports/目录，除了固定的check.summary.md和主链路检查报告外，其他报告按角色扩展（产品视角/研发视角/安全SRE视角），避免检查内容过于细碎。

案例：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1xahIK1acNakHJdmJIl2BZiaC1T7BHKyvvtRcicCrzC5H6OMeJ5M7OB7cicEVI8ibVBqibJr9Vvgsvj0k8TyvmiaEibA9dyhW2JfolgUc/640?wx_fmt=png&from=appmsg) ![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1y9wF3b0icn75szMdWsLpF3z7iccAdFPOFa3iaCibYFw5Y4FdFKibKuT11kCTJFVlibNJxz8BTjghbxJ0phQbGwq209hjtDBkv4LX2j0/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1zxvcJhEhc5icnkRCoTpMSGAwLV91NbNVxAKgiakr4fk1yq6Tvx6cRhGx2ZeLk6ibEz7I9IvoqhjyMZM0xfKW5CXyrmmTsM20n5zQ/640?wx_fmt=png&from=appmsg)

案例：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1xibFGicBuIHPF0dTTR0II1zibn7WngeryFia7ibwrvH4F3lKuicX0V3hkqphLnibwRjTplyxVVGmpwosrT3pmNiam6YpibzfJAOP7YKBIw/640?wx_fmt=png&from=appmsg)

+1 统计维度：Agent生成判定

怎么判断一个需求是不是"Agent端到端生成"的？四个硬性条件必须同时满足：

- aone\_id：spec.md元数据头中的aone\_id可在Aone系统中匹配到
- spec.md：存在且内容校验通过
- plan.md：存在且内容校验通过
- check\_reports/：存在且内容校验通过

四个条件同时满足才计入"Agent生成需求"的分子。

![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1zpvNj5AxBAXXI6lbPZZHqOCMOiaVzpCC1oC7b894320IEsRiamZ3IiabznDxZ9ib93Uqr2mLalicbHP2cXzJfB7AUeJMohfKzBkxt8/640?wx_fmt=png&from=appmsg)

session/目前作为强制上传要求，但暂不作为判定条件——思路是先把需求的相关会话数据收上来再推进问题的分析

![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1yicxY47WvH8R15RXPF09NTKZKu5MBLmCDC2ttpIuDSIjt79PxuLyfwLqehGz6wgnp0YG7gvdqFia9ibBaaXFBan2wTiaaFW0MZ7wc/640?wx_fmt=png&from=appmsg) ![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1zwE5bibdtGJVL6iaicicm8TDw9WINxcCMbC1mYyKkniaNuzDIhAkENL9NG1HboFiaFpxbbZXWfCAdNOnzCKrTODFVdicsv5DI3iakoRxY/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1zXfvng3FticY69zPRLLkAj6NwGJYr9j7URSh8nkwGv5UBFLG34LXk66sPjdfbUZo3iaTh8FZVE6XzxbyRKV8icWZl1490451BUhE/640?wx_fmt=png&from=appmsg)
