...
**来源**: https://waytoagi.feishu.cn/wiki/VbxYwFG6uizL9lk5Zlkcnt7YnW2

---

## 摘要

本文分享了写好 CLAUDE.md 的实战经验，指出应避免塞入过多信息导致 AI 迷失。核心要点包括：文件需精简在 200 行以内以节省上下文窗口；除列出技术栈外，必须明确列出禁止引入的依赖以防兼容性灾难；编码规则必须具体且可操作，拒绝“写干净代码”等模糊描述；最后，CLAUDE.md 应作为指引 AI 查找详细信息的指针，而非直接存储所有架构文档的图书馆。

---

## 正文

> 🔗 原文链接： [https://x.com/vincemask/status/2052...](https%3A%2F%2Fx.com%2Fvincemask%2Fstatus%2F2052368318825402507)
...
# CLAUDE.md 是指针，不是图书馆
反直觉点 ：你想把所有架构文档塞进 CLAUDE.md。但 CLAUDE.md 的职责不是存储信息，而是 告诉 Claude 去哪找信息 。
...
Hook 是 CLAUDE.md 规则的 强制执行层 。写在 CLAUDE.md 里的规则是「请记住」；配了 Hook 的规则是「你必须」。

# 利用 CLAUDE.md 建立长期记忆回路
