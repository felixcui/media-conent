...
原文：Designing for Agents <sup>[1]</sup>  
作者：Teddy Riker
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/ZlwY8rlDcFNWWYA5rQJeoX2OOMmOnDL1IQVkIRZHQYTdbKVYkdPTraHPkhbibylKzacVhESf6aYUWrc4oh1fWYJx1hvdcfickBq6ia6XDa4Ggs/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZlwY8rlDcFNiaKgAUYvx1IIGKHG7prt2dmibwkNxn10JsFVDbSfKwrbU3zokMysVtkibicDYzdIPlVUUAmWhZydBdE59KnJ4x5PPYx5ZQy2RUwY/640?from=appmsg)

当然，Slack 的格式指南在网上能找到，你也可以把它保存下来，再教你的智能体怎么用。但这很烦，而且本来就不该是用户需要操心的事。

你应该思考：调用你家智能体的人，需要知道什么才能成功？然后主动把这些信息交给它。不要让它自己摸索。

![](https://mmbiz.qpic.cn/mmbiz_jpg/ZlwY8rlDcFPMxuMFxblibrPrk5o4rc2UEBjibH1nz4ia8PL8xiazR3Vx37AysIrGNJm7wf8hOibWVJbJOOIE9ibBjab6NKSxKq08HOiacfxYmBOPKg/640?from=appmsg)
...
1. 1\. **每次工具调用都要求填写“理由”。** 每一次 MCP 或 CLI 工具调用，都要求 AI 智能体带上一个 `rationale` 参数，解释它为什么要发起这个请求。我们看不到聊天内容，但这个理由可以重建意图。理由里的模式，会告诉我们用户到底想做什么。
2. 2\. **提供一个反馈工具。** 我们发布了一个独立工具。当 AI 智能体遇到阻碍，或者发现某种模式行不通时，它可以调用这个工具。它会提交自己原本想做什么、尝试了什么、卡在了哪里。
3. 3\. **给特定工具加入上下文种子。** 我们会给单个工具加入专门设计的参数，用来捕捉之后会有用的上下文：这些信息智能体能拿到，但如果不主动收集，我们之后只能靠猜。
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/ZlwY8rlDcFOAw0iaVfobRfcoibUkQvJZPHCYF1W3BBHppPZUe008wVzO13gy8cp0WgRhKQUHbjzwHWiaOzSPdp9HzJrqFSrEln267SvtAgUMKE/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/ZlwY8rlDcFNUNHdPic3KHVpSwHcnuQptvCjkibkqvhlricUnXCm3Fiamb9njHFTp1EEWxIzFuHMR57FCic2Grpl7Zq857rWWCnEJ1CrlIiaRLMEIQ/640?from=appmsg)
...
`[1]` Designing for Agents: *https://x.com/teddy\_riker/status/2047312986696454584*
