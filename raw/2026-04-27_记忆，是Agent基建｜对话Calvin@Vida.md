...
**来源**: https://mp.weixin.qq.com/s/VZUhUo-ppqpICzbbGgCpbA

---

## 摘要

随着大模型能力趋于均衡，记忆与上下文正成为影响AI使用体验的核心差异，OpenAI为Codex推出记忆功能Chronicle后，清华00后开发者Calvin迅速发布了开源替代品OpenChronicle，其核心理念是将记忆作为设备侧基础设施，归属用户而非模型厂商，并支持任何具备工具调用能力的模型接入，技术上以AX Tree优先替代截图OCR方案，目标是让AI交互从无状态变为有状态，从需要用户频繁补。
...
北京时间4 月 21 日，OpenAI 给 Codex 上线了记忆功能，叫做 Chronicle，让它知道你刚才在看什么、两周前在做什么项目 [Codex 凌晨更新，将屏幕内容「放进记忆」](https://mp.weixin.qq.com/s?__biz=MzkzNDQxOTU2MQ==&mid=2247515836&idx=1&sn=58e032bf3a4c8755c05b89906bd2af2a&scene=21#wechat_redirect)
...
![](https://mmbiz.qpic.cn/mmbiz_png/jXSGuwJvpdhibLBibbVuqhSPyWP0uibzhh5AlSsk1kxVx2APDMicO6HahV8O81zxZpRRjlan43YtBw4ZjlMLOv5icuxykzfASCQmWSro4dLoqvwY/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/jXSGuwJvpdgeymhcxwpAlQ5icS2qZcz7ic9dPSUdMxlvH8nu32sLKpMWBeXxqhK841cqqzJRsW6STr6WpTQ0hYmZLCWicMGREhECTGmcaC5qxw/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/jXSGuwJvpdia4TxWVHyM71zS6Oq7hiaibxIJR3hqiaJCXCEiczNyGkQhicYgJ9TJ3o0vREuWczawdZBIFGJeHojchUc1B4uI4gibWRd9AMh93A71YU/640?wx_fmt=png&from=appmsg)
...
Calvin 说，AX Tree 在 Word、⻜书这类应⽤⾥，由于内部的渲染绕开了系统辅助通道，所以通常只能读到顶栏菜单和⽂档标题，无法以来 AX Tree。正应为如此 OpenChronicle 是个混合方案，AX Tree 优先，截图兜底
...
当然了，OpenChronicle 允许用户接入本地模型，所以如果你的电脑够强，其实...所需要的就是电费： [在笔记本上，部署 gpt-oss-120b 模型](https://mp.weixin.qq.com/s?__biz=MzkzNDQxOTU2MQ==&mid=2247503516&idx=1&sn=d54671d03a4f4fb0b889680a5e9465c3&scene=21#wechat_redirect)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/jXSGuwJvpdgJHNN0Bn9QeISKqdLUYhnhfVL0WePpiaialhqbBk9Xg9I6go8tKn4lad6ZmiapNV43F7icl6OeEngSItgwzNbtkwbb6jicUwBEwO4U/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/jXSGuwJvpdhj1SQAfjkgY8Bmy51Du5g5wQP8snnX6TyFh2e8Y0E8OdFaen94iaY1eASXq5UWicz5Jsa7jySg3Ac09IJ561DzXrdbBibFcNOquM/640?wx_fmt=png&from=appmsg)

主动式 Agent 在日常工作里的几个场景
