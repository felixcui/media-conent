...
**来源**: https://mp.weixin.qq.com/s/2TbMQqpAP60vS0D88C8nlQ
...
一、为什么从 Harness 走向 Coordination？
...
而这一次，openJiuwen 把 "协同" 这件事 —— 从理念，做成了一整套可跑、可装、可共建、且全套开源的工程交付：JiuwenSwarm。

二、Coordination Engineering 核心设计理念
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqFMkRzjIucKszZ57nIXxBenhxlS8yagt1VsqI5ElwbNtIeGLIib1NLnGu0UDpna4e1WwtHicXJuPfVo1zLaU77D84PDEsBEm2od4/640?wx_fmt=png&from=appmsg)

四个关键组件，环环相扣：

🐝 Agent Swarm —— 让多个 Agent "成军"

这是整套体系的内核。Agent Swarm 提供一套多智能体团队的协同机制，让多个 Agent 能够自主分工、动态协商、高效协作，完成从 "单兵作战" 到 "精锐团队" 的关键跨越。

JiuwenSwarm 支持成员对不同模型的路由，可针对不成角色提供合适能力的模型，减少负载压力，因材施教，提升整体效果。
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqFAtWMMibFuialsaEzS6KUTqU60MoHGDY9YYQvFkNrLsib5jwVVjibYLag9JSDDPN50Jhela2icjnfWu6UjFxMWRxp3Ymg6icC02r9FQ/640?wx_fmt=png&from=appmsg)
...
人不再是场外指挥，而是和 Agent 同队、同场景、同流程、实时协作、共同推演 —— 人，就是蜂群里的一只 "蜂"，与其他 Agent 共同协作。如狼人杀里的玩家，就是这种姿态。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqEDFGYD4lgvKL41cy3hrdOCSP2c0kA2tpHBOw40BLZ76FPfcFEdksmXsMF4CWdUxF2kaicjBOjfOtF9CAqgq8qRHraDicvRorzpk/640?wx_fmt=png&from=appmsg)

HITS 是沉浸式参与，HOTS 是全局调度 —— 两种模式是人与 Agent 团队协作的两种最核心姿态。
...
各科专家 Agent 各司其职、就本领域分析病情原因，并实时沟通诊断思路，求同存异，最终汇总为一份准确的诊断结果和治疗建议。
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqE6VQspJXamRqiaAAyiarpiaVcC31p0ma0xIowAbehzh7RAn8ScMX7iafhkg0kZ5owKQl0vjEN0dFPdibML52KRNlblRXkyYjEQpwGg/640?wx_fmt=png&from=appmsg)
...
四、协同背后：openJiuwen Harness 提供硬实力

JiuwenSwarm 的蜂群协同能力十分亮眼，但每只蜂的底座 ——openJiuwen Harness—— 同样是硬实力的来源。没有单 Agent 的强执行力，再精妙的协同机制也难以落地。

这一点，在权威评测集 PinchBench 上得到了直接验证。

PinchBench 是由 Kilo.ai 团队发布的 Agent 综合能力评测基准，任务覆盖代码开发、创意写作、文档处理、会议管理、内容转换、文件操作等多个领域。由于其任务设计贴近真实业务场景、评估维度全面，已成为衡量 Agent 执行能力的重要参考。

![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqFZT1GTbYbug63YQRvH5Va36uy8wabj2xWK6ztzXu2ia41wTH14icaIxYQNqPdU3C2jNhFUgavefCXrClWZsbvuAt5Ch3uezicJuY/640?wx_fmt=png&from=appmsg)
