...
文章提出在AI编程中应避免让AI直接“许愿式”构建整个项目，而采用“ChatGPT当架构师，Codex当执行工人”的分工模式。在Codex动手前需先建立包含项目信息、规则规范和验收标准等在内的文档包，以约束其不乱加功能。其核心思想是“最小可治理化”，即将任务拆解至能在5到10分钟内人工验收的微小Ticket，以降低大任务失败成本并便于纠错。
