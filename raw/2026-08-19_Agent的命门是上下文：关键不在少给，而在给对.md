...
**来源**: https://mp.weixin.qq.com/s/PhWGXLaWK0wEpz4Jao09ng

---

## 摘要

本文探讨了多Agent工作流中上下文管理的核心问题，作者在开发流程中引入CodeGraph等工具试图通过做减法来节省Token，却发现总成本不降反升，这打破了“少给即省”的直觉。作者由此指出，评估信息优化不能只看局部输出，而必须从行动路径和整体结果三层进行系统审视，最终得出结论：Agent的命门在于上下文，关键不在于少给信息，而在于在正确的时间把正确的信息给到正确的Agent。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr7icibg4GW8Vl28alZicNMhIPTdMdtOdfuR4c8X9ANkVxEKZSYZt5mKbkBVA8xyBBAIoIDUPOSOs9h7ia5qADQwa6RpClzrYabemtg/640?wx_fmt=png&from=appmsg)
...
我先做了一组连续 5 轮的代码理解 A/B 实验。CodeGraph 组的非缓存输入 **从 195,311 降到 125,926，减少了 35.5%** ；但 **总输入只从 732,783 降到 728,806，降幅约为 0.5%** 。

![](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr5NxB5aBVwxf0635Qv2aORPHLHEjBcDArwfibOrTAnozMuTUYDek7f3Pco7wfdjqREZ8KugHfryMpsJL64sZCJT5TSicUBVMbgf0/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr7bxAD0yEIzSMstUQyQIlCbCiciaVYD48q8TCPZia2NgQHS4WvxeCTM9InOt4u7iczTq01Uj11NvialdaHpIOe99JOicv0yy8HAsTp8U/640?wx_fmt=png&from=appmsg)
...
RTK 组 97.91% 的可改写命令实际经过了 RTK。模型看到的终端字符 **从 7,917,979 降到 4,735,635，减少 40.19%** 。

但把终端之外的过程一起放进来，画面就变了。

#### 图表 2｜RTK 压缩了局部输出，也改变了 Agent 的行动轨迹

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr5Yuzp0vficDAEcI72DQ40VPnkPO0MicoAjhoz2dC3mJGsApevWicficx8g9Y7xqk8nkNuXkeHEoVMRxFAEqz72cn2Oib5pLg0wFTjk/640?wx_fmt=png&from=appmsg) ![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr4BEx4QBHhVax3AOnuxMyRduVa3A9KDKNNYWFksHabGrbKAlw3VvgFjkgcgax7l6c8oDItESnzibRg2hkiaUro0iaUaYI8mPT6xibQ/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr4WuNOyQ1pYPDZG8LNmBYPfcOiahNZZObiaibq5KghLJxZBYKRPw9ibpwFcyomNjv43lcWllurbic7R4vsZ2TnTg9sHeUPPohfYIacI/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr4wmP1ZibGJYCN4YRqv2QKPW48GfsGHQrZjicYRcPNA1haAADbeuYtjL1uf2UJYcC6diawKYVqKnd0qKYNgjjG7mw571BjnZdBah0/640?wx_fmt=png&from=appmsg)

评价这类工具时，只看一次输出缩短多少是不够的。至少还要继续看整项任务多走或少走了几步，以及最后的结果有没有通过质量检查。

**终端少四成，只能说明终端变短了。**

![](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr5BrXnP1MMHB2r48Xb2tyZgd8tGbbSKenJ7MTZKVKd6OEB93EiadknsWRW3Xr5F5P6Yia0PoLPPuSQzD2gjtJKIYtaQTeCGMCKHw/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr6oT9kKkDyLNIpXdeiaA7thx1jF6NH9cCdbKFt0xWOTrHeBs8poEkKX0qia77lcEkkpjIcMswmb1vn8b2sTe87Rlc5rQZG9Bv71M/640?wx_fmt=png&from=appmsg) ![](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr42PHZKDkUPHtEvzp9HdYuzogl3uTssKjibHHfmX0BrRwyvibxVJKO0MjDU6RPCVRSQQ4QbDj54Ju0ZvLQvRzetagBMDvhueXp2Q/640?wx_fmt=png&from=appmsg)

每个阶段仍然会把完整产物写进 `artifacts/` ，只是派发消息不再内嵌整份报告，而是传 Handoff 和 Artifact 路径。

角色之间传递信息的方式也随之改变：

![](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr7KMJlYy6TZeSxfqhX0lq23O73Pgvb6wXnzNjTrbhBcIaJOSOR2R8NwaWYhEHa8c6OXhldKfNCia6ZazMqy56wTyXQc0fStkgAY/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr6rBM1ozc7ic9tBjvMuwP6ibcCMnxmwfdfJR7rGxkH8OxZd5AUm2jOAnH8Y225X6mGuhLxciaHQiaCdN3icyL4S2nWdicwxE5wdgZr3Q/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr65L5UOk5Bk87QHpXL5Am8xuoXbJoVxMJcpOEHz9L2TViakVOueRaUjaD1xS8rY69NBD2qptqiaS9ic2LQRzZ8NuFCicuVj0ln9tos/640?wx_fmt=png&from=appmsg)

**5.1 GLM：步骤几乎没变，每一步变轻了**

改造前后模型步骤几乎没变，221 次变成 220 次；平均每一步携带的 Token 却 **从约 10.68 万降到 6.70 万** 。

Developer 阶段从 12.041M 降到 5.438M，一项就省下约 6.60M，占整条流程净节省的 74.5%。Design、Review 和知识沉淀也明显下降。

#### 图表 3｜GLM 各阶段 Token 消耗变化

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr5CA61kdgZzl1FdDnAH0BHMX7vtHUbVEickQZtCDTsaNRl62oUgTXHg03fq97mAQLhX8Ry0S2L5fO7JIHacGowea0KkDFsbF9u0/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr6UsjxQcSoic1WcQaciaS7ia7AfFkDnFnXq4onh5RgKEfzaHvhiaOyb2ARn0LKmSic1WrpLPiaePf3N0ibqgMddetM6rakmchOalYPYK8/640?wx_fmt=png&from=appmsg)
...
上下文 **给多了** ，噪声和历史携带会持续收费； **给少了** ，Agent 会用更多搜索、测试和修复补齐证据。
