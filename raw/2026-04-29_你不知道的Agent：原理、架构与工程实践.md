from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=8)
...
![四种记忆类型与存储位置：上下文窗口位于运行时 messages[]，Skills、JSONL 会话历史和 MEMORY.md 位于磁盘，生命周期和注入方式各不相同](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM6RUVDUAvBfm5tJqVTlE7pA7uxx3WlHbic0PI3gehku7ictQib67QYMjFqFTzzGazfXczRWauatogib0nZJxichVrekmoS4kzAZg0OTS7icRdEmOD4A/640?wx_fmt=svg&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=9)
...
![Initializer + Coding Agent 跨 session 协作流程：Initializer 只运行一次并生成 feature-list.json、init.sh、初始 commit 和 claude-progress.txt，后续 Coding Agent 在多个 session 中通过文件系统恢复状态、实现单个功能、测试、更新 passes 并提交代码](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM70YQPVfR1w7qKaBSv5RPneUVxeMhp3byPO9vJibibVRy8zLo1D17LH40iaJ8wxztBa24EaOzH8M0PPz369yOKcPIpuPRHrHd1OfXUAcIwGapXMg/640?wx_fmt=svg&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=11)
...
![AI 工作模式变化](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM42VqXAZmEJsp3fTMCic8SWUEia3C9icoICMWhvQQSDl4l1vnxIluTMdkXZmPPpCkkBsBn92KfhTVfGicUMtzZWibe2jHZE6njSFlbByygjVXibEzmg/640?wx_fmt=svg&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=12)

常见的组织方式是主 Agent 作为 Orchestrator 统筹全局，下挂多个子 Agent 独立并行工作，它们之间通过 JSONL inbox 协议通信，用 Worktree 隔离文件修改，用任务图管理依赖关系。

![多 Agent 拓扑](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM5yMic4s5uB3QRbAic9Q1NzTHQkqL3RjRp2kq6wGQAKTjIvib7hrkbL6Vu1gw6xPzvCKawjPaeHZ2danA7XZPvudbjVnxlemPg1v5gvQusfm6ZEA/640?wx_fmt=svg&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=13)
...
![多 Agent 协作协议](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM7KfYO1RYvFuiayGEmtHCicR5eOFNW5oIzb2fOHLesQkmS11IqYyu8vM4OjPXrlgUmFpXBGJXwaA0nsAfmaWkpn46YcceyRWiaUTPBCib5iczp0n9A/640?wx_fmt=svg&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=14)
...
![多 Agent 幻觉放大](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM5J1FtT2iaKSjS5PXa1oEp1vZ57pnUN9BwbCcE8Nhqg7DWg5IDrUMkBCKWppt0aj4icmUou6oAKiaxic3saUyNRNRq6TWKKJZfLpCxwEqAJiaj1erA/640?wx_fmt=svg&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=15)
...
![Single-turn vs Agent 评测对比：Single-turn 是 Prompt 进 LLM 出 Response 直接打分，Agent 则需要 Tools、Environment、Task 协同，Agent 多步调用工具并更新环境状态，最后验证环境实际结果而非只看输出文字](https://mmbiz.qpic.cn/sz_mmbiz_png/yE1BYA2cY10ahn9ial5hPyCnobFUywerj0chLiaSKYQ4EZlKntybGfTmKd4nyEibDPcocT6ibIFK6EKGtzytZU8AvlUxt5wQJWqHrWTCYyblCgg/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=16)
...
![Agent 评测的组成部分：task、trial、grader、transcript、outcome、evaluation harness、agent harness 和 evaluation suite](https://mmbiz.qpic.cn/sz_mmbiz_png/yE1BYA2cY13iaYATVSzvc8Aq4K1XxY2RaEQibZwjLqUXoLcDpt4zkxAjlXh1gupehzPH0keibupkqjU8zZKDs4XZicL95yrtYwCOlupqMZRC1jY/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=17)
...
| ![调查：团队实际使用的评测方式，Offline evaluation on test sets 54.5%，Online evaluation on production data 44.8%，Not evaluating yet 22.8%](https://mmbiz.qpic.cn/mmbiz_png/yE1BYA2cY10u5N1icSN2wGxOsT32wGqgnGiafWicXgTRMclWgicbWHYfCsdxyiaib4wuUdNViaG3n9WHy1eZkEAibmEwjmDjKIHibMowicoBKicXmnn0Jk/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=18) | ![调查：常用评测指标，Internal human review/labelling 59.8%，LLM-as-judge 53.3%，Traditional ML/DS metrics 16.9%](https://mmbiz.qpic.cn/sz_mmbiz_png/yE1BYA2cY12acicrwqWcic093SicRcmT9AU7axt6QIHicpj8us3CIOVaUEeFUodr1RhxgwgHze1iczTlEvHMQziauPHicap4IYoM6PWOpgbO38lr98/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=19) |
| --- | --- |
...
![Success rate vs infra error rate：横轴是评测容器的资源余量从 1x 到 Uncapped，蓝色是模型得分，红色是基础设施错误率，资源越受限红色越高蓝色越低](https://mmbiz.qpic.cn/sz_mmbiz_png/yE1BYA2cY12DibCjIIf8q6gajEp18pAJibOuUmY4icKmcKSJficJj0vGYMibEp7Kcv7e9wxqVvpE5MvicnH8EWW0UzKz9t5P3UwkibE9kX88ubJuiaQ/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=20)
...
![两层可观测性](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM6TZOuSjCs6Vd3P5rNib0fCCiarEUhS3sSOh5ls9W8H6krfbksmsia9lVMRVUy0lSulc2ia0gKSL6eg50Sib2KWG2NEbLfsTpgkl3xw6FRVcZHxfyw/640?wx_fmt=svg&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=21)
...
![事件流可观测性](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM4drBsD1iaDKsicg3JKfOlYYyzbkc77icolOB8eWkqO77O4t20wHE2GsqAX1sNSFPfyW9cG65ictTpM4UbvoxUXGZIBqpxuK2M4UZsgvJ6RtzMib9A/640?wx_fmt=svg&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=22)
...
![OpenClaw 整体架构](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM7Kt5sprZApiczaD3FvT3EcQ13ABxEE1vicyqtlBQnhkygjFNhm63VFyoTgjBthVecqiaUn8f9uhDvsS6HhwVAQ2K0zibafsITdshatMwlEtKvIdA/640?wx_fmt=svg&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=23)
...
![系统提示分层叠加](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM6d5Zg7lJ7xVpgBETJqkRQY2Auf1mcST6ziamADUBsTyV6PWS6WDZxNicH3Z6nQmVgibzz1Oq1bnfHgbuKnBNDM1Z4Xcib9987qiazHHKFd2LtxfKQ/640?wx_fmt=svg&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=24)
