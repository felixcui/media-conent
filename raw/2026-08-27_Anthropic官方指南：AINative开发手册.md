...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/jXSGuwJvpdjibPzwJAKYIaIHA6NHxkeGT6dXXjPjtDQ1ib9CCv9kiaOjILxUwOBjSOblKTMOricAse6DwIx3W9laibg12iaP2Jko0MYjZbDxh3Oiao/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/jXSGuwJvpdgiallZGHgiabQ70Cb0TFCicrMOia5icFAd7oPHEGiaficQpH3JCOiaqIpOL6FUZUiapSykUFeuK9lgmdXmcIs6H2UDL9yLATZMqlKQg1D4/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/jXSGuwJvpdiaibH2d1lYozyL2BbETyN6MGIouiaEaxlGpNezWPDPOiadCZ2ITaHyicr2nxmBD3VcggrgPib1kmk61WtTKa7MZM8a8mSTnLo6tBtl0/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/jXSGuwJvpdiaOS1uib90QP9I8p8cXoVuEqe52njcNHiaHcPvBdKr361vicwWXtqErJjuwGcxDWpicgtuJZVOibib9FyYldCYecmfUzNdeGHPrOiajBI/640?from=appmsg)
...
```
#!/bin/bash # Production deploys require a named release authorization cmd=$(jq -r '.tool_input.command' < /dev/stdin) if [[ "$cmd" == *"deploy"* && "$cmd" == *"production"* ]]; then    if [ -z "$RELEASE_APPROVAL" ]; then      echo "Production deploys need a release authorization." >&2      exit 2    fi fi exit 0
```
...
![](https://mmbiz.qpic.cn/mmbiz_png/jXSGuwJvpdjoArm3cuzP3vY4icmd4PTFvYLRLFKSLqWNgEINyrDibjfRZpjLNZcakxolf8dxibvap4cQic36qicriciaM0IUVazq891hicv7HBdw774/640?from=appmsg)
