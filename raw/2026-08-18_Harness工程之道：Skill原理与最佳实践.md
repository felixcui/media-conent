...
**来源**: https://mp.weixin.qq.com/s/fVqp5E-UJ9-b7kgAcvekCw

---

## 摘要

Agent Skills 是一种轻量开放的 AI Agent 能力扩展规范，旨在解决传统 Prompt 工程因全量加载导致的上下文臃肿、注意力稀释与不可复用问题。它将领域知识与工作流封装为可移植模块，核心原理为渐进性披露，通过发现、激活和执行三个阶段实现知识按需加载，以最小上下文成本换取最大知识覆盖。
