...
**来源**: https://mp.weixin.qq.com/s/jBmSs1ELTdQVwaF-9mT_8g
...
随着近期 AI 模型的发展，AI 在代码补全、通用编程辅助、图像分析等领域带来的结果稳定性和飞速编程体验不断突破了传统编程模式，但回归垂直领域，这些工具仍无法直接实现业务的端到端交付。
...
![](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp3l4gW87HeSIt7SLsGvzX0qOAXxR2NGFnozsFM1mVwPNDcEguiapjt9QPM8efwvokzLPMrlu7v4qRvicM8U7WBFnia8t3Sd3awAY8/640?wx_fmt=png&from=appmsg)

![](https://mmbiz.qpic.cn/mmbiz/DthwRd8vvp0BAdC7u0MULbI545IIicgdAQy6uLueJ7qRhn0FbsRXotAZMiafEJibu8kE3pdks7fU0Z5GQcp7VXhjBkPgD9N8icRvUDlNXajfQiag/640?wx_fmt=other&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp3ocseKmWfE1ibKBDDfHlhqQyKCfaiaWC9U81HDhDVEeS4ZCFDF9gOhqqYs8TdMppXbjnVcAgD5X6yCqogUqvjqkic5INAAJmbPvM/640?wx_fmt=png&from=appmsg)

▐ **Agent 调度中枢与决策机制**

Agent 作为整个系统的调度中枢，核心职责是获取用户的输入和工作空间信息，并确认以下关键信息来决策后续流程：

![](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp1ib5x6ZGibAly9HSCgjbiawj9R0BJAI3OEKOr36ID2Rs0JTc35hdPqBiagcf2uSodXySibe7fRteunNndRYnlj0h1AkDvwnjicb2RMI/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp3gicj1P3xTQe1HSRibqic2hqibEknHuLQuRRKKBvyaZIBcZpWDTzceGhc6rQcTNPFH1IVFUugg0cZZcOazDU7bEJxxkZDUsZKL3EU/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp1Guz30D08NMAfo7iba73T7EKKAeyyAnuTRaScic8rNTeKniafKeVhmfe36ibIH0PjxRo8W35rGHCnDBQMD2pciaTml7a4WaD0Wiaeww/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz/DthwRd8vvp3iaWpxx6OKXgV4RZwbicaibh7MvoibHa6nFib7dib7hViahLibPzTLG8BcytCsuiaKJFM8Nkc4gl1sTzCVYnaQR2S8MTicDCc9iaMMZZDans/640?wx_fmt=other&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp1t1iaHhPaYfRScrDKfX1snKbftbVFibNTHliaBjC1zAlVnRXtKgUOIbJjlGMNJvWdNCqnEjD9Tv0sjic2oGVtiarrbibpibiaF1fTmDe0/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp3FRwUJYCicmtz98hqtxkXJDsnXG9zLvUicAXuxl61zrdibNZy93V1Ys6dFSIHDFjsdO9cTgEMpiaERZsiakUXbIwQRsn78TsjpWaTs/640?wx_fmt=png&from=appmsg)

![](https://mmbiz.qpic.cn/mmbiz/DthwRd8vvp3GZxnaK1bwjoY3bWQfWBmDzbHZxBmia6DHFw55m1GTmBoia3NFtGJO9P2HGicpbgLMtibniasn9rhIvJKDiaMJic2uibWp3DQbCfhDhTw/640?wx_fmt=other&from=appmsg)
...
2. 结构化提取：将非结构化的对话内容转换为符合知识库格式的结构化条目
3. 冲突检测：检查新知识是否与现有知识冲突，避免覆盖已有内容
4. 安全提交：通过 Git 提交变更，保留完整的修改记录
5. 即时生效：下次对话时自动拉取最新知识库

![](https://mmbiz.qpic.cn/mmbiz/DthwRd8vvp1GpAnZOUnNLOAKGdAHw5d7hicZ6lm1q1HP1pNbFoNXVDE11FIUKzTf9Y3nwB349FA4fyDt9tn19sI8LymI2rW5Yuy5jmvvib6ek/640?wx_fmt=other&from=appmsg)

安全机制

知识库的自动更新带来了信息安全和恶意篡改的风险，我们通过以下机制保障安全：

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/DthwRd8vvp2s3ictN0EyALa7aat8yStxxnsUcnSly0pddoVeR725O2HVcibMRRNPJdwt9nwEvN3vwHJtVUFC80dltAGKS4zKDofHib9VKwicpx4/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/mmbiz/DthwRd8vvp3nKMk1dOMvdfPpXVTicNEHIZ9icuEHOToGp4zFeictvSNT5KPgHVeXhKQS7LaFyibSPg5PstdcbeAHNOz2AoicGGsgBK4TYC7RZvzI/640?wx_fmt=other&from=appmsg)

- 五层知识体系

![](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp1lunIFnIthaHJUCLqUP49TMVXKabWwey9e7pQfoic6OwO5fDDpdQlhG5ibnZVTLMWYQkuiby0egMqM8TPw1OrD2Fpccia1BslFLgg/640?wx_fmt=png&from=appmsg)
...
```xml
<!-- 本文档为"概述索引类"文档，旨在说明在什么场景下需要/必须使用此 npm 包，如果 npm 包含多个子包，会具体区分每个子包的使用场景，帮助 AI 大模型决策使用哪个子包 --># ${组件名称}## 概述<!-- 组件概述信息 -->## 子目录清单### ${子目录-1}#### 功能清单<!-- 应用场景摘要，用于匹配功能 -->#### 视觉规范<!-- 视觉摘要，用于匹配 UI -->### ${子目录-2}#### 功能清单<!-- 应用场景摘要，用于匹配功能 -->#### 视觉规范<!-- 视觉摘要，用于匹配 UI -->
```

内容结构设计：

```xml
<!-- 本文档为"应用说明类"文档，旨在告诉大模型在给定的实际业务场景下如何合理、正确、高效地使用 npm 包 --># ${子目录-1}## 概述<!-- 应用场景摘要，用于匹配功能 -->## 安装<!-- 安装说明，bash 命令 -->## 规则<!-- 以下为示例规则 -->- 熟读 [API 文档](#API) 文档，禁止使用未声明的属性。- 熟读 [代码演示](#代码演示)，快速学习组件在组件在实际业务场景下的使用方式并且理解如此设计的原因，当用户需求需要使用某一类组件时，优先参考 [代码演示](#代码演示) 中该组件提供的方案，如果现有方案无法解决实际问题，参考 [API 文档](#API) 提供的基础能力进行开发。- 实现需求时需要仔细地阅读和理解组件 [视觉规范](#视觉规范)  - 如果需要定义组件样式，需要保证定义新的样式与内置样式匹配。  - 如果需要将组件与其他 React 组件进行组合，需要保证组合后的样式与组件内置样式匹配。  - **重点关注样式如下**: 颜色、背景色、宽度、高度、字号、单位。其他样式需要根据实际需求自行判断。<!-- 其他组件相关的特殊规则需额外定义  --><!-- 其它 showcase / badcase 可额外补充 -->## 代码演示<!-- 完整的组件代码示例，需明确 props 传入格式和消费场景，便于 AI 理解 -->## API<!-- 组件 props 定义、工具方法 fields 字段定义、枚举场景定义；typescript 效果 > table 描述  -->## 视觉规范<!-- 基于 ai 分析的视觉，用于 d2c 链路，本章节内容可不补充  -->
```
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp03zFBbf6EBKBricTZibOfsiaDeNTKewFVo2lqU8qYrtoicTksbia8uJyvKgwWTP9AZV4M3NW6FQtOZYBc29K0HyvhPT7gTE0tYmhuY/640?wx_fmt=png&from=appmsg)
...
2. 容易遗忘：业务压力下，文档更新往往被忽略
3. 版本滞后：文档与代码版本不一致，导致 Agent 生成错误代码
4. 质量参差：不同开发者写的文档质量不一

- 解决方案：Git Hooks + LLM 自动同步

我们设计了完全自动化的文档更新机制：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp2ru6SAu59IDfIz9MWu7ju8HYT48GW6XVRkRTicwcQia4moorTcjO5geDlUePDlevvaicBib8iabyOgOPl04aoNCrn9FzIhiaIELv39U/640?wx_fmt=png&from=appmsg)

核心实现

```bash
#!/bin/sh# 加载 .env 文件中的环境变量if [ -f .env ]; thenexport $(grep -v '^#' .env | xargs)finpx @ali/hp-agent@beta llm-doc-sync "同步并且允许推送（不必询问）"
```

核心能力

1. 开发者提交代码时，Husky 自动触发 `llm-doc-sync` 命令
2. `llm-doc-async-agent` 分析 `Readme.md` 和 `src/*` 的变更内容，自动推送更新到知识库仓库
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp1ATBicIf0wZd3lyticUWS5eapeZsGicmcibSZfe1jXzV20C5MibSGNSZlSB6DGl8zkBmD5BXrxJBGQcOO4vriaosVYtOqfAH58039fo/640?wx_fmt=png&from=appmsg)

- 现有方案的核心问题

1. 设计规范依赖：需要设计师严格遵循 Auto Layout 等规范
2. 语义识别不准：难以区分卡片、列表、网格等相似布局
3. 组件匹配缺失：无法与业务组件库关联
4. Token 消耗过大：长页面的 schema 数据量巨大

▐ **我们的方案：结构化数据 + 多模态还原 + 领域 DSL**

- 整体架构

![](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp1d1dsGDesoGvQbWcDUhibVjndyRbG88X5gh9lxTWjIQevAYWEBjgc8tc8C4oPicUQbntzTDibFibe6Yg8N7940icM1MDehSKfq1ibO0/640?wx_fmt=png&from=appmsg)
...
| 设计稿截图 | 还原效果 |
| --- | --- |
| ![](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp2yUAiaOjBjI3M9xib2dgYbqURNDslPWTVj2tFjm2iaq74j1d8LcUicaaSFwfkRa0tzTHoR32f2dcGNRIDVlWdPdXqIqB0hzRwRdd8/640?wx_fmt=png&from=appmsg) | ![](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp3icdDD09uGctoYvJ0TrJwSV5a7TN1zcVuXjIfKhdCPEM3OFKia2vHSkpB0RG0U00epd6W3qXJNY58ENibfpiaEd7m7EzezuLfQnAo/640?wx_fmt=png&from=appmsg) |
...
![](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp25rVrGCEYkzuGibPkoyGgLyFyosPalXhwTtPpeicaYHFzfVH3iakE5TCxwaibk9H4hlYenNGE3kSg1S2uOZ1UoIXk73J32NAdAFBI/640?wx_fmt=png&from=appmsg) ![](https://mmbiz.qpic.cn/mmbiz_png/33P2FdAnju8PWonAvnSfAGMpeE3YoiaMhZMffic8JnvvLIgyJ9CUGzAiaiciaG61AHjhJSiaA5tmQZRSVFNRf3iabgibww/640?wx_fmt=png&from=appmsg)
